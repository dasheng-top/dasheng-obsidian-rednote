...
interface RedSettings {
    ...
    splitMode: 'heading' | 'auto'; // 分割模式：按标题 or 自动
    layoutMode: 'heading' | 'free'; // 排版模式：按标题分割 or 自由排版
...
export const DEFAULT_SETTINGS: RedSettings = {
    ...
    showTime: true,
    timeFormat: 'zh-CN',
    splitMode: 'heading' as 'heading' | 'auto',
    layoutMode: 'free' as 'heading' | 'free',
    headingLevel: 'h2', // 默认使用二级标题
    footerLeftText: '一念成佛,一念成魔,AI时代重生平等',
    footerRightText: '欢迎关注公众号：智前程',
    customFonts: [
        {
