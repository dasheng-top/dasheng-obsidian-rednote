...
export const VIEW_TYPE_RED = 'dasheng-obsidian-rednote';
...
export class RedView extends ItemView {
    ...
    private async getTemplateOptions() {
        const layoutMode = this.settingsManager.getSettings().layoutMode || 'free';
        return this.imgTemplateManager.getImgTemplateOptions(layoutMode);
    }
